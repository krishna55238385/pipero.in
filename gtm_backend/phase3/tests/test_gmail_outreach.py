...
from gtm_backend.phase3.connectors import gmail_smtp
...
def _patch_reads(seq_rows, chan_rows, leads, unsub=None, sent=None, replied=None, opened=None):
    ...
    """
    mod = "gtm_backend.phase3.agents.agent_14_orchestrator.supabase"
...
def test_gmail_dry_run_writes_dry_run_entries(
    ...
    with _patch_reads([sample_sequence_row], [sample_channel_plan_row], [sample_lead]), patch(
        ...
        "gtm_backend.phase3.agents.agent_14_orchestrator.get_settings", return_value=_settings(),
    ), patch(
        "gtm_backend.phase3.agents.agent_14_orchestrator.gmail_smtp.send_html_email",
...
def test_gmail_skips_outside_send_window(
    ...
    with _patch_reads([sample_sequence_row], [sample_channel_plan_row], [sample_lead]), patch(
        ...
        "gtm_backend.phase3.agents.agent_14_orchestrator.get_settings",
...
def test_gmail_enforces_daily_cap(
    ...
    with _patch_reads(
        ...
        "gtm_backend.phase3.agents.agent_14_orchestrator.get_settings", return_value=_settings(daily_send_cap=1),
    ):
        summary = run_gmail_orchestration(icp_id=1, dry_run=True)
...
def test_gmail_campaign_id_threads_into_tracking_links(
    ...
    with _patch_reads([sample_sequence_row], [sample_channel_plan_row], [sample_lead]), patch(
        ...
        "gtm_backend.phase3.agents.agent_14_orchestrator.email_render.render_email_html",
...
def test_gmail_sends_when_configured(
    ...
    with _patch_reads([sample_sequence_row], [sample_channel_plan_row], [sample_lead]), patch(
        ...
        "gtm_backend.phase3.agents.agent_14_orchestrator.gmail_smtp.is_configured", return_value=True,
    ), patch(
        "gtm_backend.phase3.agents.agent_14_orchestrator.gmail_smtp.send_html_email",
...
def test_tracking_open_returns_pixel_and_records():
    import gtm_backend.phase3.tracking_server as ts
