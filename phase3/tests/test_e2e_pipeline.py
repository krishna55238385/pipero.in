...
import phase3.main as phase3_main
...
def test_phase3_pipeline_end_to_end(
    ...
    with contextlib.ExitStack() as stack:
        stack.enter_context(_p(
            "phase3.agents.agent_11_personalisation.llm.chat_json", side_effect=llm_route))
        stack.enter_context(_p(
            "phase3.agents.agent_12_copywriter.llm.chat_json", side_effect=llm_route))
        stack.enter_context(_p(
            "phase3.agents.agent_13_channel_strategy.llm.chat_json", side_effect=llm_route))
        stack.enter_context(_p(
        ...
        stack.enter_context(_p(
            "phase3.agents.agent_13_channel_strategy.supabase.get_icp", return_value=fake_icp))
        stack.enter_context(_p(
        ...
        stack.enter_context(_p(
            ...
            return_value=[sample_lead]))
        stack.enter_context(_p(
            "phase3.agents.agent_14_orchestrator.supabase.get_sent_lead_ids", return_value=set()))
        stack.enter_context(_p(
            "phase3.agents.agent_14_orchestrator.supabase.get_replied_lead_ids", return_value=set()))
        stack.enter_context(_p(
            "phase3.agents.agent_14_orchestrator.instantly.is_configured", return_value=False))
        ...
        upsert_seq = stack.enter_context(_p(
            "phase3.agents.agent_12_copywriter.supabase.upsert_sequence", return_value=None))
        ...
        insert_log = stack.enter_context(_p(
            "phase3.agents.agent_14_orchestrator.supabase.insert_outreach_log", return_value=None))
