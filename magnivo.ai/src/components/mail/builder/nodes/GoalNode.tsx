...
export default function GoalNode({ data, selected, id }: NodeProps<CampaignBuilderNode>) {
  ...
  return (
    <div className={`min-w-[200px] rounded-xl border p-3 bg-white dark:bg-card shadow-sm transition-all ${borderClass}`}>
      ...
      <div className="flex items-center gap-2.5">
        <div className="h-8 w-8 rounded-lg bg-rose-500/10 text-rose-600 grid place-items-center">
