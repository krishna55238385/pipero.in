...
export default function DelayNode({ data, selected, id }: NodeProps<CampaignBuilderNode>) {
  ...
  return (
    <div className={`min-w-[200px] rounded-xl border p-3 bg-white dark:bg-card shadow-sm transition-all ${borderClass}`}>
      ...
      <div className="flex items-center gap-2.5">
        <div className="h-8 w-8 rounded-lg bg-teal-500/10 text-teal-600 grid place-items-center">
          <Timer className="h-4 w-4" />
        </div>
        <div className="min-w-0 flex-1">
          <p className="text-[10px] text-muted-foreground uppercase tracking-wide font-medium">Delay</p>
