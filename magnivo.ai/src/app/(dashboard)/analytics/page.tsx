...
import { getLlmUsageSummary, getMarketSizing, getIcps, getRevenueForecast, getBoardReport, getRoiAttribution } from '@/app/actions/gtm'
...
export default async function AnalyticsPage(props: { searchParams: Promise<{ days?: string }> }) {
    ...
    const [data, usage, market, icps, forecast, boardReport, roi] = await Promise.all([
        getAnalytics(days),
        getLlmUsageSummary(),
        getMarketSizing(),
        getIcps(),
